...
class AddEditPolicyScreen extends GetView<PolicyFormController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          controller.editingPolicy == null ? 'Add Policy' : 'Edit Policy',
        ),
      ),
      body: Form(
            ...
            children: [
              ...
              Obx(
                () => ListTile(
                  ...
                  onTap: () =>
                      controller.pickDate(context: context, isStartDate: true),
                ),
              ),
              Obx(
                () => ListTile(
                  ...
                  trailing: const Icon(Icons.calendar_today_outlined),
                  onTap: () =>
                      controller.pickDate(context: context, isStartDate: false),
                ),
              ),
              SizedBox(height: responsive.itemGap),
              TextFormField(
