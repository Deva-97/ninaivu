...
void main() {
  group('ReminderRepositoryImpl', () {
    test('markReminderCompleted cancels the notification and queues an update', () async {
    ...
    test('markReminderRenewed updates linked policy and enqueues both records', () async {
      final currentUser = testUser();
      final reminder = testReminder();
