...
void main() {
  group('FollowUpRepositoryImpl', () {
    test('addFollowUp writes locally and enqueues create for offline sync', () async {
    ...
    test('rescheduleFollowUp updates local schedule and queues pending update', () async {
      final currentUser = testUser();
